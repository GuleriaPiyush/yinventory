  ...
  return (
    <>
      <style>{`
        ...
        .landing-btn-secondary .landing-arrow {
          display: inline-block;
          transition: transform 0.2s ease;
        }
        
        .landing-btn-secondary:hover .landing-arrow {
        ...
        .landing-hover-card:hover {
          ...
          box-shadow: 0 24px 48px -16px rgba(99, 102, 241, 0.18);
        ...
        .landing-form-card:hover {
          transform: translateY(-4px);
          box-shadow: 0 20px 40px -16px rgba(99, 102, 241, 0.12);
